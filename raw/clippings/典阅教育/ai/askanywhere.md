...
github 地址：[https://github.com/skyconnfig/askanywhere](https://github.com/skyconnfig/askanywhere)
...
###数据库使用sql server数据库名称deepseek命令行功能，准确查询笔记，删除笔记等内容，记录，活动总结，日总结月总结等，生成数据库表格脚本，全面掌握日常活动信息， 主界面结合RAG,每次提问会通过查询历史信息进行匹配回答可配置调用地址apikey以及web访问提供记忆调取，所以回复相对较慢，日常提问建议使用划词提问，在主窗口可以沟通询问，总结近期活动，询问日程安排等等，默认每次打开会总结上一天内容，此时询问可能得不到准确答复。
...
> 更新: 2025-03-03 12:45:39  
> 原文: <https://www.yuque.com/lixinsi/vnere7/bdmye5ag5abf3zo7>