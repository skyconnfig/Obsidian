...
truncate table bsi_FormNameRelationship  --流程设置表单名称关系表
truncate table bsi_KeyAnswer --关键字答案表
truncate table bsi_Task--任务主表
truncate table bsi_TaskBuiltInPolicy --内置保单表
truncate table bsi_TotalResult--成绩主表
truncate table bsi_TotalResultDetailed--成绩明细表

truncate table bsi_File --存档公司表
truncate table bsi_FilePostRelationship --存档岗位关系表 

truncate table bsi_Examination --考试设置
truncate table bsi_ExaminationTaskRelation --考试案例关系表
...
--理论知识
truncate table bsi_Curriculum --课程
truncate table bsi_Chapter  --章
truncate table bsi_Section  ---节
truncate table bsi_Resources --资源表
...
truncate table tb_HB_Examination
truncate table tb_HB_ExaminationPapers
truncate table tb_HB_Paper
truncate table tb_HB_QuestionBank
...
> 更新: 2024-12-18 11:28:36  
> 原文: <https://www.yuque.com/lixinsi/kmvnv0/zipx19>