...
# 传参检测
[ $# -ne 6 ] && echo -e "Usage: $0 rootpasswd netnum nethosts cri cni k8s-cluster-name\nExample: bash $0 lxs19861019 10.0.1 128\ 129\ 130\ 131\ 133\ [containerd|docker] [calico|flannel] test\n" && exit 11 
...
[下载k8s镜像](https://cloud.189.cn/t/3YBV7jzQZnAb (访问码:0xde))



> 更新: 2022-06-22 17:01:59  
> 原文: <https://www.yuque.com/lixinsi/ii9bf8/kw36bu>