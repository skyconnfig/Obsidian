# framework-rule-claude405

````plain
# React B端管理系统基础框架 - 一步到位创建

请在当前工作目录下创建一个完整的React B端管理系统基础框架，严格按照以下规范一次性创建所有文件。
...
**请严格按照上述所有规范，一次性创建完整的React B端管理系统框架！**
...
> 更新: 2025-08-16 21:17:54  
> 原文: <https://www.yuque.com/lixinsi/dtxgrg/cw9mwklrwg5c6tx2>