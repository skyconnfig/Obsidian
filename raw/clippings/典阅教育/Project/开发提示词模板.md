...
![1754014503570-c6352c72-3da1-4072-ae96-e37aeb596682.png](./img/SHGpTlxkEwokAcHY/1754014503570-c6352c72-3da1-4072-ae96-e37aeb596682-527366.png)
...
我要做一个票据助手网站，基于nodejs20+Vue3+vite+TypeScript
直接使用 Vite 模板，完全跳过交互，可以直接使用 Vite 的 Vue+TS 模板: npm init vite-init@latest -y . "--" --template vue-ts
需要补充需求点，票据核对



我要做一个票据助手管理平台，基于nodejs20+Vue3+vite+TypeScript
直接使用 Vite 模板，完全跳过交互，可以直接使用 Vite 的 Vue+TS 模板: npm init vite-init@latest -y . "--" --template vue-ts
...
管理平台的左侧菜单新增一个系统管理的菜单，这个是一级菜单，还要支持二级菜单功能，二级菜单包含管理员用户管理、菜单管理、权限管理、系统日志
...
> 更新: 2025-08-01 10:15:07  
> 原文: <https://www.yuque.com/lixinsi/dtxgrg/stu0spb2gs1vzmso>